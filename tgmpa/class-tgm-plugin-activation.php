...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Instalar Plugins Obrigatórios', 'tgmpa' ),
				'menu_title'                      => __( 'Instalar Plugins', 'tgmpa' ),
				/* translators: %s: plugin name. */
				'installing'                      => __( 'Instalando Plugin: %s', 'tgmpa' ),
				/* translators: %s: plugin name. */
				'updating'                        => __( 'Atualizando Plugin: %s', 'tgmpa' ),
				'oops'                            => __( 'Algo deu errado com a API do plugin.', 'tgmpa' ),
				'notice_can_install_required'     => _n_noop(
					/* translators: 1: plugin name(s). */
					'O plugin Jetimob requer o seguinte plugin adicional: %1$s.',
					'O plugin Jetimob requer os seguintes plugins adicionais: %1$s.',
					'tgmpa'
				),
