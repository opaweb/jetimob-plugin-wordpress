...
class WP_GitHub_Updater {
	...
	public function upgrader_post_install( $true, $hook_extra, $result ) {
		...
		$fail  = __( 'O plugin foi atualizado mas não pode ser reativado. Ative o plugin manualmente', 'github_plugin_updater' );
		$success = __( 'Plugin reativado com sucesso.', 'github_plugin_updater' );
